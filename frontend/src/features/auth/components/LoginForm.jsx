      ...
      <div>
        ...
        <div className="relative">
          ...
          <input
            ...
            className={`w-full rounded-xl border py-3 pl-10 pr-4 outline-none transition focus:ring-4 ${
              errors.email
      ...
      <div>
        ...
        <div className="relative">
          ...
          <input
            ...
            className={`w-full rounded-xl border py-3 pl-10 pr-12 outline-none transition focus:ring-4 ${
              errors.password
                ? "border-red-400 focus:ring-red-100"
                : "border-slate-300 focus:border-blue-500 focus:ring-blue-100"
            }`}
